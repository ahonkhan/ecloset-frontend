...
const HaveCoupon = () => {
    return (
        <div className='site-container mt-8'>
            <div className="bg-white font-WorkSans py-3 px-4 flex items-center gap-2 rounded">
                ...
                <p className='text-darkBlue hover:underline cursor-pointer'>Click here to enter your code</p>
            </div>
        </div>
    )
}
