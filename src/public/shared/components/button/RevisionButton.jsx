    ...
    return (
        <div class="flex items-center justify-center bg-gray-100 dark:bg-gray-900">
            <div class="max-w-sm mx-auto p-8 bg-white rounded-xl shadow-md space-y-2 sm:flex sm:items-center sm:py-4 sm:space-y-0 sm:space-x-6 ">
                <img class="h-24 mx-auto rounded-full ring-4 ring-green-400 sm:mx-0 sm:flex-shrink-0 transform hover:scale-105 duration-500"
                ...
                <div class="text-center space-y-2">
                    <div class="space-y-0.5" >
                        <h1 class=" text-black font-semibold">My name is Jahida</h1>
                        <p class="text-gray-500 font-medium"> I  am a Software Engineer</p>
                    </div>

                    <button class=" first-letter: btn btn-purple">visit now </button>
                    <button className={`btn btn-green ml-2 `}>link</button>
                </div>
            </div>
        </div>
    );
        ...
        <div class="h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
            <div class="max-w-sm mx-auto p-8 bg-white rounded-xl shadow-md space-y-2 sm:flex sm:items-center sm:py-4 sm:space-y-0 sm:space-x-6 ">
                ...
                <div class="text-center space-y-2">
                    ...
                    <button class=" first-letter: btn btn-purple">visit now </button>
                    <button className={`${style.default} btn btn-green ml-2 `}>link</button>
                </div>
            </div>
        </div>
    );
