...
export const Navbar = () => {
    ...
    return (
        <nav className={`${style.HeaderPaddingDesktop} ${isFixed ? 'py-2.5' : 'py-4'} duration-200 bg-white hidden lg:flex sticky top-0 items-center ${globalContext.ModalOpenStatus ? '' : 'z-[70]'}  gap-12 `}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); window.scrollTo(0, 0); searchHandler(); }} className="search-bar border-[1.5px] flex justify-between rounded-3xl items-center border-gray-300 w-full h-[44px] px-1">
