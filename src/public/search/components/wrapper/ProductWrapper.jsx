    ...
    return (
        <>
            ...
            <section className='flex site-container mt-6 gap-4' >
                ...
                <div className={`fixed ${context.searchFilterStatus ? '' : 'translate-x-full md:translate-x-0'} duration-300 md:static top-0 right-0 z-[80] md:z-[40] md:block w-full xs:w-[300px]  shrink-0`}>
                ...
                <div className={`fixed ${context.searchFilterStatus ? 'opacity-100' : 'pointer-events-none opacity-0'} md:hidden duration-300 h-screen z-[70] w-screen bg-black bg-opacity-50 top-0 left-0`}>
                </div>
            </section >
        </>
    )
